...
LIBRETRO_PPSSPP_CONF_OPTS += -DCMAKE_C_FLAGS="$(TARGET_CFLAGS) -fno-math-errno -DEGL_NO_X11=1 -DMESA_EGL_NO_X11_HEADERS=1 -flto=auto"
LIBRETRO_PPSSPP_CONF_OPTS += -DCMAKE_CXX_FLAGS="$(TARGET_CXXFLAGS) -fno-math-errno -DEGL_NO_X11=1 -DMESA_EGL_NO_X11_HEADERS=1 -flto=auto"
